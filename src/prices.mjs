...
function createApp(database) {
  ...
  function isHoliday2 (date) {return database.getHolidays().forEach((row) => { date && date.year === parseTemporalPlainDate(row).year && date.month === parseTemporalPlainDate(row).month && date.day === parseTemporalPlainDate(row).day });}
